...
export default function OfficerSidebar() {
  ...
  const mainItems = [
    { name: 'Overview', path: '/officer', icon: LayoutDashboard, exact: true },
    { name: 'Requests', path: '/officer/requests', icon: ClipboardList },
    { name: 'Board', path: '/officer/kanban', icon: Columns },
    { name: 'Dispatch', path: '/officer/dispatch', icon: UserCheck },
    { name: 'Schedule', path: '/officer/schedule', icon: CalendarDays },
    ...
    >
      ...
      <div style={{ padding: '20px 18px 14px' }}>
        ...
        <div style={{ marginTop: 8, fontSize: 11.5, color: 'var(--ink-3)', lineHeight: 1.35 }}>
          Estate Management
          <div style={{ fontSize: 10.5, color: 'var(--ink-4)' }}>Juristic Officer Portal</div>
        </div>
      </div>
